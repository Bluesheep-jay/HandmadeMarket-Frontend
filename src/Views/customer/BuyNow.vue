  ...
  <q-page padding>
    <div class="row q-col-gutter-lg">
      ...
      <div class="col-12 col-md-8">
        <div class="text-h4 q-mb-md">Mua ngay cùng Hmm</div>
...
onBeforeMount(async () => {
  ...
  cartData.value.cartItems.push(JSON.parse(localStorage.getItem("cartItem")));
    console.log(cartData.value.cartItems)
